...
import top.coos.server.web.listener.FileProgressiveFutureListener;
...
public class Response {
	...
	public ChannelFuture sendNotModified() {
		...
		return this.setStatus(HttpResponseStatus.NOT_MODIFIED)
				.setHeader(HttpHeaderNames.DATE.toString(), DateUtil.formatHttpDate(DateUtil.date())).send();
	}
