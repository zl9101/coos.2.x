...
public class Request {
		...
		if (dataType == HttpDataType.Attribute) {
			...
			if (fileUpload.isCompleted()) {
				try {
					...
					log.error("Get file param [{}] error!", e, data.getName());
				}
			}
		}
	}
	...
	public void setContext(Context context) {
		...
		if (StrUtil.isEmpty(context.getContextPath())) {

		} else if (context.getContextPath().equals(ServerSetting.ROOT_CONTEXT)) {
