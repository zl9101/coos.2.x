...
public final class DbUtil {
				...
				try {
					if (obj != null) {
						if (obj instanceof ResultSet) {
							...
							log.warn("Object {} not a ResultSet or Statement or PreparedStatement or Connection!", obj
									.getClass().getName());
						}
					}
		...
		for (int i = 0; i < params.length; i++) {
			...
			if (null != param) {
				...
				try {
					...
					// ignore
					// log.warn("Null param of index [{}] type get failed, by: {}",
	 ...
	 * @since 3.2.3
	 */
	public static PreparedStatement prepareStatement(Connection conn, String sql, Collection<Object> params)
			throws SQLException {
