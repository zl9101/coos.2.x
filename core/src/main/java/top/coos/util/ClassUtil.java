...
import top.coos.core.lang.ClassScaner;
...
public class ClassUtil {
	 ...
	 *            类名和方法名表达式，例如：com.xiaoleilu.hutool.StrUtil#isEmpty或com.
	 *            xiaoleilu.hutool.StrUtil.isEmpty
	 * @param isSingleton
	...
	public static boolean isSimpleValueType(Class<?> clazz) {
		...
		return isBasicType(clazz) || clazz.isEnum() || CharSequence.class.isAssignableFrom(clazz)
				|| Number.class.isAssignableFrom(clazz) || Date.class.isAssignableFrom(clazz) || clazz
						.equals(URI.class) || clazz.equals(URL.class) || clazz.equals(Locale.class)
