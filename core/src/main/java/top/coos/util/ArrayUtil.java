...
import top.coos.core.collection.IterUtil;
...
public class ArrayUtil {
	...
	public static <T> T[] insert(T[] buffer, int index, T... newElements) {
		...
		final T[] result = newArray(buffer.getClass().getComponentType(), Math.max(buffer.length, index)
				+ newElements.length);
	...
	public static boolean isArray(Object obj) {
		...
		if (null == obj) {
			// throw new
			// NullPointerException("Object check for isArray is null");
			return false;
		}
