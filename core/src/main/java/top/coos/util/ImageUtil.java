...
import top.coos.core.codec.Base64;
...
public class ImageUtil {
	 ...
	 *            水印的字体颜色
	 * @param font
	 *            {@link Font} 字体相关信息，如果默认则为{@code null}
	 * @param x
	 ...
	 *            透明度：alpha 必须是范围 [0.0, 1.0] 之内（包含边界值）的一个浮点数字
	 */
	public static void pressText(InputStream srcStream, OutputStream destStream, String pressText, Color color, Font font,
	 ...
	 *            透明度：alpha 必须是范围 [0.0, 1.0] 之内（包含边界值）的一个浮点数字
	 */
	public static void pressText(ImageInputStream srcStream, ImageOutputStream destStream, String pressText, Color color,
	 ...
	 * @since 3.2.2
	 */
	public static void pressText(Image srcImage, OutputStream to, String pressText, Color color, Font font, int x, int y,
			float alpha) throws IORuntimeException {
	 ...
	 *            目标图像流
	 * @param pressImg
	 *            水印图片，可以使用{@link ImageIO#read(File)}方法读取文件
	 * @param x
	 *            修正值。 默认在中间，偏移量相对于中间偏移
	 * @param y
	 *            修正值。 默认在中间，偏移量相对于中间偏移
	 ...
	 *             IO异常
	 */
	public static void pressImage(ImageInputStream srcStream, ImageOutputStream destStream, Image pressImg, int x, int y,
			float alpha) throws IORuntimeException {
	 ...
	 *            {@link Image}
	 * @param imageType
	 *            {@link BufferedImage}中的常量，图像类型，例如黑白等
	 * @return {@link BufferedImage}
