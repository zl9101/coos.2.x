...
import top.coos.core.comparator.VersionComparator;
import top.coos.core.convert.Convert;
import top.coos.core.lang.Matcher;
import top.coos.core.text.StrBuilder;
import top.coos.core.text.StrFormatter;
import top.coos.core.text.StrSpliter;
import top.coos.core.text.TextSimilarity;
...
public class StrUtil {
	 ...
	 * @param version2
	 *            版本2
	 * @return 排序值。负数：version1 &lt; version2，正数：version1 &gt; version2,
	 *         0：version1 == version2
	 * @since 4.0.2
	 */
	 ...
	 *            需要添加到结尾的字符串
	 * @param suffixes
	 *            需要额外检查的结尾字符串，如果以这些中的一个为结尾，则不再添加
	 *
	 ...
	 *            需要添加到首部的字符串
	 * @param prefixes
	 *            需要额外检查的首部字符串，如果以这些中的一个为起始，则不再添加
	 *
	 * @return 如果已经结尾，返回原字符串，否则返回添加结尾的字符串
	 * @since 3.0.7
	 */
