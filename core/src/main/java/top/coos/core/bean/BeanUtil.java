...
import top.coos.core.bean.copier.BeanCopier;
import top.coos.core.bean.copier.CopyOptions;
...
public class BeanUtil {
	...
	private static Map<String, PropertyDescriptor> internalGetPropertyDescriptorMap(Class<?> clazz, boolean ignoreCase)
		...
		final Map<String, PropertyDescriptor> map = ignoreCase ? new CaseInsensitiveMap<String, PropertyDescriptor>(
	 ...
	 * 
	 * @param bean
	 *            Bean对象，支持Map、List、Collection、Array
	 * @param expression
	 *            表达式，例如：person.friend[5].name
	 * @return Bean属性值
	 ...
	 * @since 3.2.3
	 */
	public static Map<String, Object> beanToMap(Object bean, Map<String, Object> targetMap, final boolean isToUnderlineCase,
