package top.coos.core.comparator;
...
import top.coos.core.lang.Chain;
...
public class ComparatorChain<E> implements Chain<Comparator<E>, ComparatorChain<E>>, Comparator<E>, Serializable {
	 ...
	 *            {@link Comparator} 列表
	 * @param bits
	 *            {@link Comparator} 列表对应的排序boolean值，true表示正序，false反序
	 */
	...
	public boolean equals(final Object object) {
		...
		if (object.getClass().equals(this.getClass())) {
			...
			return (null == orderingBits ? null == otherChain.orderingBits : this.orderingBits
					.equals(otherChain.orderingBits)) //
